...
$.fn.dateSelect = function(options) {
	...
	var _dateBody = "<div class='tz-datepicker' id='datepicker_"+elem_id+"'>" +
			...
			"<span class='year'><span class='span-year'>2015</span><div class='year-list' id='ylist_"+elem_id+"'><ul></ul><div class='year-change'><span class='year-left'></span><span class='year-right'></span></div></div></span>" +
			"<span class='month'><span>6月</span><div class='month-list' id='mlist_"+elem_id+"'><ul><li data-id='1'>1月</li><li data-id='2'>2月</li><li data-id='3'>3月</li><li data-id='4'>4月</li><li data-id='5'>5月</li><li data-id='6'>6月</li>" +
								"<li data-id='7'>7月</li><li data-id='8'>8月</li><li data-id='9'>9月</li><li data-id='10'>10月</li><li data-id='11'>11月</li><li data-id='12'>12月</li></ul></div></span>"+"<span class='right'>></span></div>" +
    ...
    $("#datepicker_" + elem_id ).on("click",".year .span-year",function(){
    	...
    	for(tz_y_s; tz_y_s <= tz_y_e; tz_y_s++)
    	{
    		...
    		$("#datepicker_" + elem_id + " .year-list ul").append("<li class='"+y_a+"'>"+tz_y_s+"年"+"</li>");
    	}	
    ...
    $("#datepicker_" + elem_id ).on("click",".year li",function(){
    	...
    	$(this).parents(".year-list").prev("span").text(tz_y+"年");
    ...
    $("#datepicker_" + elem_id ).on("click",".year-change span",function(){
    	...
    	for(tz_y_s; tz_y_s <= tz_y_e; tz_y_s++)
    	{
    		...
    		$("#datepicker_" + elem_id + " .year-list ul").append("<li class='"+y_a+"年"+"'>"+tz_y_s+"年"+"</li>");
    	}	
    ...
    {	
    	...
    	$("#datepicker_" + elem_id +" .day li").first().css({"margin-left":50*dayOfWeek});
    }
